...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void getBetween() throws Exception {
        List<MealTo> expected = MealsUtil.getWithExcess(Arrays.asList(MEAL3, MEAL2, MEAL1), MealsUtil.DEFAULT_CALORIES_PER_DAY);

        LocalDateTime start = LocalDateTime.of(2015, 5, 30, 10, 0);
        LocalDateTime end = LocalDateTime.of(2015, 5, 30, 20, 0);
