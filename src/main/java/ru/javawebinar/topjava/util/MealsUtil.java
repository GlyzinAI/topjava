...
public class MealsUtil {
    ...
    public final static List<Meal> STORAGE = new MealServiceImpl(new MealRepositoryImpl()).getAll();

    public static void main(String[] args) {
        List<MealTo> mealsWithExcess = getFilteredWithExcess(STORAGE, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
        mealsWithExcess.forEach(System.out::println);

        System.out.println(getFilteredWithExcessByCycle(STORAGE, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
        System.out.println(getFilteredWithExcessInOnePass(STORAGE, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
        System.out.println(getFilteredWithExcessInOnePass2(STORAGE, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
    }

    public static List<MealTo> getWithExcess(List<Meal> meals, int caloriesPerDay) {
        return getFilterWithExcess(meals, meal -> true, caloriesPerDay);
    }

    public static List<MealTo> getFilterWithExcess(List<Meal> meals, Predicate<Meal> filter, int caloriesPerDay) {
