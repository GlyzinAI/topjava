...
public class MealsUtil {
    ...
    public static List<MealTo> getWithExcess(List<Meal> meals, int caloriesPerDay) {
        return getFilteredWithExcess(meals, meal -> true, caloriesPerDay);
    }

    public static List<MealTo> getFilteredWithExcess(List<Meal> meals, Predicate<Meal> filter, int caloriesPerDay) {
